  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input-border bg-background/50 backdrop-blur-sm hover:bg-accent/20 hover:text-accent-foreground hover:border-accent/50",
        ...
        glass: "bg-gradient-glass border border-glass-border backdrop-blur-md hover:bg-gradient-card hover:border-accent/30 text-foreground shadow-card",
        glow: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-intense hover:scale-105 animate-glow-pulse",
        neon: "bg-background-secondary border border-accent text-accent hover:bg-accent hover:text-background shadow-glow hover:shadow-intense",
        success: "bg-success text-background hover:bg-success-glow shadow-glow",
        warning: "bg-warning text-background hover:bg-warning-glow shadow-glow"
      },
      size: {
